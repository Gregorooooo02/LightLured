	...
	SubShader
	{
		...
		Pass
		{
			...
			v2f_surf vert_surf (appdata v )
			{
				...
				TVEModelData Data15_g158263 = Data16_g156809;
				...
				float4 lerpResult131_g158271 = lerp( SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_WindBaseTex, sampler_Linear_Clamp, float3(temp_output_75_0_g158271,temp_output_82_0_g158271), 0.0 ) , SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_WindNearTex, sampler_Linear_Repeat, float3(temp_output_119_0_g158271,temp_output_82_0_g158271), 0.0 ) , saturate( ( ( saturate( ( distance( Input_Position180_g158271 , (TVE_RenderNearPositionR).xyz ) / (TVE_RenderNearPositionR).w ) ) - temp_output_7_0_g158276 ) / temp_output_10_0_g158276 ) ));
				...
				half2 Base_Direction893_g158262 = (( mul( unity_WorldToObject, float4( appendResult79_g158266 , 0.0 ) ).xyz * ase_parentObjectScale )).xz;
				...
				v.vertex.xyz += staticSwitch14_g158319.rgb;
			...
			fixed4 frag_surf (v2f_surf IN, out float outDepth : SV_Depth ) : SV_Target
			{
				...
				float localCustomAlphaClip19_g158313 = ( 0.0 );
				float temp_output_3_0_g158313 = Out_AlphaClip4_g158308;
				float Alpha19_g158313 = temp_output_3_0_g158313;
				float temp_output_15_0_g158313 = 0.0;
				float Treshold19_g158313 = temp_output_15_0_g158313;
				...
				clip(Alpha19_g158313 - Treshold19_g158313);
				#endif
				#else
				clip(Alpha19_g158313 - Treshold19_g158313);
				#endif
				...
				fixed3 albedo = lerpResult87_g158305;
				fixed3 normal = Out_NormalWS4_g158308;
				half3 emission = (Out_Emissive4_g158308).xyz;
				fixed3 specular = ( lerpResult28_g158306 * RenderSpec105_g158305 );
				fixed metallic = 0;
				half smoothness = break24_g158305.w;
				half occlusion = 1;

				float3 Transmission = 1;
				float3 Translucency = 1;

				fixed alpha = Alpha19_g158313;
...
Node;AmplifyShaderEditor.FunctionNode;464;-4096,-256;Inherit;False;Block Emissive;277;;158247;64497f287b9096b43b688b52b4a0bf20;5,282,0,273,0,275,0,264,0,267,0;3;146;OBJECT;0,0,0,0;False;148;OBJECT;0,0,0,0;False;178;OBJECT;0,0,0,0;False;1;OBJECT;183
Node;AmplifyShaderEditor.GetLocalVarNode;448;-4096,-128;Inherit;False;406;Model Frag;1;0;OBJECT;;False;1;OBJECT;0
Node;AmplifyShaderEditor.FunctionNode;470;-6016,-256;Inherit;False;Block Lite Impostor Motion;331;;158262;38077585734a3224db90527d4119d9c6;0;2;146;OBJECT;0,0,0,0;False;212;OBJECT;0,0,0,0;False;1;OBJECT;128
...
Node;AmplifyShaderEditor.FunctionNode;429;-2944,0;Inherit;False;Block Lite Cutout;244;;158284;0780bee94024ab547ae8bb1fac250cb1;2,775,0,824,0;0;1;COLOR;566
...
Node;AmplifyShaderEditor.FunctionNode;425;-2944,64;Inherit;False;Block Lite Dithering;261;;158289;6e52cef07120daa408f9658182b29574;3,847,0,848,0,855,1;0;1;COLOR;566
Node;AmplifyShaderEditor.FunctionNode;463;-3712,-256;Inherit;False;Block Subsurface;301;;158290;d738d295ada6b1f409db6776b5efe789;3,315,1,359,1,362,0;4;146;OBJECT;0,0,0,0;False;385;OBJECT;0,0,0,0;False;371;OBJECT;0,0,0,0;False;361;FLOAT;1;False;1;OBJECT;183
...
ASEEND*/
//CHKSM=902DEB2555B123B60D85534C35DCAC8B7E351535